...
public class MathUtils {
  public static Matrix4f createTransformatioMatrix(Vector3f translation, float rotX, float rotY, float rotZ,
      float scale) {
  ...
  public static Matrix4f createViewMatrix(Camera camera) {
    ...
    Matrix4f.translate(new Vector3f(-camera.getPosition().x, -camera.getPosition().y, -camera.getPosition().z), matrix,
        matrix);
